				...
				<div className={style.backgroundDiv}>
					<ul className={style.nav}>
						...
						<li className={style.navItem}>
							<a
								style={{ padding: '0px' }}
								href='https://res.cloudinary.com/gabrielcon6/image/upload/v1631918733/myPortfolio/Gabriel_Resume_18SEP_mxyhdp.pdf'
								download
								target='_blank'
							>
								{' '}
								Resume &nbsp; <img src='download.png' height='10px'></img>
							</a>
						</li>
					</ul>
				</div>
